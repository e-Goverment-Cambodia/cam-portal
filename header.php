...
<head>
	...
	<style>
			...
			.primary-background-color, .lg-main-nav ul ul, .pagination ul li.active span, .nav-sidebar-2 ul li.active, .nav-sidebar-3 ul li.active, .languages ul li.current-lang { background-color: <?php echo $theme_color; ?>; }
